...
class TradeListResponse(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of TradeListResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of TradeListResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "trades": [TradeResponse.from_dict(_item) for _item in obj.get("trades")] if obj.get("trades") is not None else None
        })
        return _obj
