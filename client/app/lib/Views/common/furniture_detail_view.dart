                        ...
                        children: [
                          ...
                          IconButton(
                            ...
                            icon: const Icon(
                              ...
                              shadows: [
                                BoxShadow(
                                    color: Color(0xff000000), blurRadius: 8)
                              ],
                            ),
                            onPressed: () {
                              ...
                              children: [
                                ...
                                ElevatedButton(
                                  ...
                                  style: ElevatedButton.styleFrom(
                                    backgroundColor: const Color(0xffffffff),
                                    foregroundColor: ThemeColors.lineGray2,
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      border: Border.all(
                                        color: isFavorite.value
                                            ? ThemeColors.lineGray2
                                            : ThemeColors.lineGray1,
                                      ),
                                    ),
                                    child: Row(
                                      mainAxisAlignment:
                    ...
                    ? Positioned(
                        ...
                        child: Container(
                          ...
                          decoration: const BoxDecoration(
                            color: Color(0xffffffff),
                            border: Border(
                                top: BorderSide(color: ThemeColors.bgGray1)),
                          ),
                          child: Center(
