    ...
    return Scaffold(
      ...
      bottomNavigationBar: Container(
        decoration: const BoxDecoration(
          border:
              Border(top: BorderSide(color: ThemeColors.bgGray1, width: 0.5)),
        ),
          ...
          items: [
            BottomNavigationBarItem(
              activeIcon: Padding(
                ...
                child:
                    Image.asset('assets/images/menu_home_fill.png', scale: 2),
              ),
              icon: Padding(
                padding: const EdgeInsets.only(bottom: 4),
            ...
            BottomNavigationBarItem(
              activeIcon: Padding(
                padding: const EdgeInsets.only(bottom: 4),
                child:
                    Image.asset('assets/images/menu_user_fill.png', scale: 2),
              ),
              icon: Padding(
                padding: const EdgeInsets.only(bottom: 4),
